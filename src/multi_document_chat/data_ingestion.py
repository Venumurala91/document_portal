...
class DocumentIngestor:
    ...
    def __init__(self, temp_dir:str = "data/multi_doc_chat",faiss_dir: str = "faiss_index", session_id: str | None = None):
        try:
            ...
            # base dirs
             # Create base directories for temporary files and FAISS indexes
            ...
            # Sesssion specific directories 
            self.session_temp_dir = self.temp_dir / self.session_id
            self.session_faiss_dir = self.faiss_dir / self.session_id

            # This will creates directories 
        ...
        try:
            ...
            for uploaded_file in uploaded_files:
                ...
                temp_path = self.session_temp_dir / unique_filename
                 ...
                 # Save the uploaded file to the session-specific temp directory
                ...
                self.log.info("File saved for ingestion", filename=uploaded_file.name, saved_as=str(temp_path), session_id=self.session_id)
                 ...
                 # Load the file content using the appropriate loader
                if ext == ".pdf":
                ...
                # Extract documents from the loader and add them to the list
                docs = loader.load()
                documents.extend(docs)
            
             # Raise exception if no valid documents were loaded
            if not documents:
